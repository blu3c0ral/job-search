...
const USER_PROMPT_TEMPLATE = `Here is the candidate profile:
...
const VERDICT_TO_ENUM: Record<string, string> = {
...
async function evaluateMatch(
  ...
  // Function-form replacement avoids JavaScript's $&/$'/`$\`` special handling in
  // the replacement string — a JD or profile containing those literals would
